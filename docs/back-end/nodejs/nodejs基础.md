...
![image-20220622214226512](../typora-user-images/image-20220622214226512.png)
...
![image-20220731112253687](node.assets/image-20220731112253687.png)
...
访问：http://127.0.0.1/public/1.png
...
![image-20220731153523306](node.assets/image-20220731153523306.png)

中间件函数的形参列表中，必须包含next参数，而且路由处理函数只包含req和res

#### （1）**next函数**：实现多个中间件连续调用的关键，表示转交给下一个中间件或路由

![image-20220731154218909](node.assets/image-20220731154218909.png)
...
4. express内置的中间件
   ...
   **（1）express.json**
   ...
   ![image-20220731183431199](node.assets/image-20220731183431199.png)
   ...
   **（2）express.urlencoded**
   ...
   ![image-20220801210541005](node.assets/image-20220801210541005.png)
...
![image-20220803203009802](node.assets/image-20220803203009802.png)
...
![image-20220803205108013](node.assets/image-20220803205108013.png)
...
- HTTP头部信息不超过以下几种字段：无自定义头部字段
  ...
  ![image-20220803220051942](node.assets/image-20220803220051942.png)
...
![image-20221029195149386](node.assets/image-20221029195149386.png)

![image-20221029195229405](node.assets/image-20221029195229405.png)
...
![image-20221029200149450](node.assets/image-20221029200149450.png)
...
![image-20221030103910820](node.assets/image-20221030103910820.png)
